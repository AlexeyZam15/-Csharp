...
task42 - Дано  натуральное  n,  вычислите 1/0! + 1/1!+ ... + 1/n!

task43 - Даны два натуральных числа a и b.  
Вычислите НОД(a,b) - наибольший общий делитель а и b.

task44 - Даны два натуральных числа a и b.  
Вычислите НОД(a,b) - наибольший общий делитель а и b, алгоритмом Евклида.

task45 - Даны натуральные a и b, не равные 0 одновременно. Найдите 
d = НОД(a,b) и такие целые x и y, что d = a · x + b · y.

task46 - Загадано число от 1 до 100. Найти число с помощью алгоритма бинарного поиска.

task47 - Найти индекс числа в отсортированном массиве с помощью бинарного поиска.

task48 - Напишите программу, которая 
...
task49 - Напишите программу, которая 
...
task52 - Напишите программу, которая 
...
task53 - Напишите программу, которая 
